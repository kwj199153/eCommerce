...
<style scoped>
.intel-analysis-config { padding: var(--space-4) 0; }
.scope-alert { margin-bottom: var(--space-14); }
.scope-alert :deep(.ant-alert) { font-size: var(--font-size-12); }
...
.quick-tips { margin-top: var(--space-12); padding: var(--space-12); background: var(--success-bg); border-radius: var(--radius-8); border: 1px solid var(--success-border); }

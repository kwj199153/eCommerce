...
async def monitor_competitor(
    ...
    """
    try:
        result = await service.monitor_competitor(request, store_id=store_id)
        return result
...
async def get_monitor_dashboard(
    ...
    """获取所有竞品的监控仪表盘数据（无需参数）"""
    request = CompetitorMonitorRequest()
    return await service.monitor_competitor(request, store_id=store_id)


# ==================== 批量追踪 ====================

@router.post("/track/batch", response_model=CompetitorAnalysisResponse, summary="ASIN 批量追踪")
async def track_batch_asins(
    ...
    """
    try:
        result = await service.track_batch_asins(request, store_id=store_id)
        return result
    except Exception as e:
...
async def analyze_market_share(
    ...
    """
    try:
        result = await service.analyze_market_share(request, store_id=store_id)
        return result
    except Exception as e:
...
async def get_market_share_by_category(
    ...
    return await service.analyze_market_share(request, store_id=store_id)
...
async def analyze_pricing_strategy(
    ...
    """
    try:
        result = await service.analyze_pricing_strategy(request, store_id=store_id)
        return result
    except Exception as e:
...
async def analyze_competitor_reviews(
    ...
    """
    try:
        result = await service.analyze_competitor_reviews(request, store_id=store_id)
        return result
    except Exception as e:
...
async def get_review_analysis(
    ...
    return await service.analyze_competitor_reviews(request, store_id=store_id)
...
async def detect_intruders(
    ...
    """
    try:
        result = await service.detect_intruders(request, store_id=store_id)
        return result
    except Exception as e:
...
async def detect_intruders_by_category(
    ...
    return await service.detect_intruders(request, store_id=store_id)
...
async def analyze_buy_box(
    ...
    """
    try:
        result = await service.analyze_buy_box(request, store_id=store_id)
        return result
    except Exception as e:
...
async def compare_competitors(
    ...
    try:
        ...
        result = await service.compare_competitors(request, store_id=store_id)
        return result
